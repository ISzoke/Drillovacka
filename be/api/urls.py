...
urlpatterns = [
    ...
    path('classrooms/<int:classroom_id>/hardest-examples/', views.get_classroom_hardest_examples, name='classroom-hardest-examples'),
    path('classrooms/<int:classroom_id>/students/<int:student_id>/ai-insight/', views.student_ai_insight, name='student-ai-insight'),
    path('classrooms/<int:classroom_id>/students/<int:student_id>/attempts/', views.student_attempt_log, name='student-attempt-log'),
    ...
    path('teacher/examples/unassigned-count/', views.teacher_examples_unassigned_count, name='teacher-examples-unassigned-count'),
    path('teacher/examples/<int:example_id>/', views.teacher_example_detail, name='teacher-example-detail'),
    path('teacher/examples/bulk-set-grade/', views.teacher_examples_bulk_set_grade, name='teacher-examples-bulk-set-grade'),
    path('teacher/examples/bulk-delete/', views.teacher_examples_bulk_delete, name='teacher-examples-bulk-delete'),
    path('teacher/examples/bulk-add-to-task/', views.teacher_examples_bulk_add_to_task, name='teacher-examples-bulk-add-to-task'),
    path('teacher/examples/bulk-create-task/', views.teacher_examples_bulk_create_task, name='teacher-examples-bulk-create-task'),
    ...
    path('teacher/tasks/<int:task_id>/generate-more/', views.teacher_generate_more_examples_preview, name='teacher-generate-more-examples'),
    path('teacher/tasks/<int:task_id>/generate-more/save/', views.teacher_save_generated_examples, name='teacher-save-generated-examples'),
